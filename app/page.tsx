    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="text-center z-10 max-w-6xl mx-auto relative">
        ...
        >
          ...
          >
            <span className="text-purple-300 font-semibold text-sm tracking-wider">
        ...
        >
          <div className="flex flex-col md:flex-row justify-center gap-4 w-full max-w-xl mx-auto">
            <MagneticButton className="bg-gradient-to-r from-purple-600 to-blue-600 px-8 py-4 rounded-2xl text-white font-bold text-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 border border-purple-500/30">
              🚀 VIEW ELITE PROJECTS
            </MagneticButton>
            <MagneticButton className="border-2 border-purple-500 px-8 py-4 rounded-2xl text-purple-300 font-bold text-lg hover:bg-purple-500 hover:text-white transition-all duration-300 backdrop-blur-lg">
              📧 HIRE ME NOW
            </MagneticButton>
          </div>
        </motion.div>
  ...
  const experiences = [
    {
      ...
      logo: "🏢",
      description:
        "Developing and maintaining web applications for a growing tech company. Working with modern technologies to build scalable solutions and contributing to the company's digital transformation.",
      achievements: [
    ...
    },
    {
      ...
      logo: "📈",
      description:
        "Started my professional journey at a fast-growing fintech startup. Gained hands-on experience with modern web development practices and financial technology systems.",
      achievements: [
                  ...
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6 mb-8">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-xl text-purple-300 font-semibold mb-1">
                          {exp.role}
                        </p>
                    ...
                    <div
                      className={`px-6 py-3 bg-gradient-to-r ${exp.color} rounded-2xl text-white font-bold text-center min-w-fit`}
                    >
                      {exp.impact}
                    </div>
                  </div>
          ...
          {skillCategories.map((category, index) => (
            ...
            >
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 hover:scale-105 transition-all duration-500 hover:border-purple-500/40 h-full">
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${category.gradient} opacity-5 rounded-3xl group-hover:opacity-10 transition-opacity duration-500`}
                />
  ...
  const projects: Project[] = [
    {
      ...
      description:
        "Modern trading dashboard with real-time data visualization and portfolio management features for retail and professional traders.",
      longDescription:
        "Built a comprehensive trading dashboard from scratch using React and Node.js. Features include real-time market data, interactive charts, portfolio tracking, and risk management tools. Integrated with multiple financial APIs and implemented secure user authentication and authorization.",
      image: "📈",
      technologies: [
        "React",
        "Node.js",
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                {Object.entries(selectedProject.metrics).map(([key, value]) => (
                  <div
                    key={key}
                    className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 text-center border border-white/10"
                  >
                    <div className="text-3xl font-bold text-white mb-2">
                      {value}
                    </div>
                    <div className="text-gray-400 capitalize font-semibold">
                      {key}
                    </div>
                  </div>
                ))}
